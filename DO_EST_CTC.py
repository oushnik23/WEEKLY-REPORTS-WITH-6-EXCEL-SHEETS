...
where Area IN ("DO","TR") and EstBlf IN ("EST") and Centre IN ("KOL","SIL") and Season IN (2025) and Category IN ("CTC") and
...
excel_path = "DO_EST_CTC.xlsx"

with pd.ExcelWriter(excel_path, engine="xlsxwriter") as writer:
    dfa2.to_excel(writer, sheet_name="DO EST TOP 20 CTC", startrow=3, index=True, header=True)
    workbook  = writer.book
    worksheet = writer.sheets["DO EST TOP 20 CTC"]
...
with pd.ExcelWriter(excel_path, engine="openpyxl", mode="a", if_sheet_exists="overlay") as writer:
    ...
    dfb2.to_excel(writer, sheet_name="DO EST TOP 20 CTC", startrow=start_row)
...
ws["B1"] = "TOP 20 DO/TR EST CTC GARDEN"
